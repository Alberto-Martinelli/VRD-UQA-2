...
from transformers import (
    Qwen2_5_VLForConditionalGeneration,  # Qwen3-VL reuses this class in transformers
    AutoProcessor,
)
...
class Qwen3VLEvaluator:
    def __init__(self, config_path):
        ...
        self.model_config = self.config["open_source_models"]["qwen3"]
    ...
    def initialize_model(self):
        ...
        print("Qwen3-VL model initialized successfully")
                ...
                messages.append(
                    {
                        "role": "user",
                        "content": [
                            *[{"type": "image", "image": f"file://{path}"} for path in window],
...
def main():
    ...
    Qwen3VLEvaluator(args.config_path).evaluate()
